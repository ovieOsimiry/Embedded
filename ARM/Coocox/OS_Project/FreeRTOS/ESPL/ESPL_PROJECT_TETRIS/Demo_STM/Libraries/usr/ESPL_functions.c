...
volatile ADC_InitTypeDef ADC_InitStruct;
...
void gpioInit() {
	...
	/* Connect Button E pin to EXTI line 0*/
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOA, EXTI_PinSource0);//Configure ESPL_Pin_Button_E as EXTI input
	...
	/* Enable and set EXTI0 Interrupt to the lowest priority */
	   NVIC_InitStructure.NVIC_IRQChannel = EXTI0_IRQn;// EXTI0_IRQn //EXTI15_10_IRQHandler;//
  ...
  /* Enable and set EXTI2 Interrupt to the lowest priority */
	   ...
	   /* Connect Button B pin to EXTI line 4*/
	  SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOE, EXTI_PinSource4);//Configure ESPL_Pin_Button_B
	  ...
	  /* Enable and set EXTI4 Interrupt to the lowest priority */
	   ...
	   /* Connect Button C pin to EXTI line 5*/
	  SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOE, EXTI_PinSource5);//Configure ESPL_Pin_Button_C
	  ...
	  /* Connect Button A pin to EXTI line 6*/
	...
	/* Enable and set EXTI9_5 Interrupt to the lowest priority */
	   NVIC_InitStructure.NVIC_IRQChannel = EXTI9_5_IRQn;//  //EXTI15_10_IRQHandler;//EXTI15_10_IRQn;//
	   NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = configLIBRARY_LOWEST_INTERRUPT_PRIORITY;
	   NVIC_InitStructure.NVIC_IRQChannelSubPriority = configLIBRARY_LOWEST_INTERRUPT_PRIORITY;
	   NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	   NVIC_Init(&NVIC_InitStructure);

...
{ 
  ...
  LTDC_InitStruct.LTDC_BackgroundRedValue = 0x80;          //changed from 0 for testing purposesi    
  ...
  LTDC_InitStruct.LTDC_TotalHeigh = 327; //Changed from 327
...
void LCD_LayerInit(void)
{
  ...
  LTDC_Layer_InitStruct.LTDC_ConstantAlpha = 127; //changed from 0xff
...
//  LTDC_Layer_InitStruct.LTDC_BlendingFactor_2 = LTDC_BlendingFactor2_PAxCA;
  ...
  LTDC_DitherCmd(DISABLE);   //Changed from ENABLE as flickering was too visible
}

...
====================================== 
*/
void gDrawPiece (int pX, int pY, int pPiece, int pRotation)
{
...
void gDrawScene ()
{
	gDrawBoard ();													// Draw the delimitation lines and blocks stored in the board
	gDrawPiece (mPosX, mPosY, mPiece, mRotation);					// Draw the playing piece
	gDrawPiece (mNextPosX, mNextPosY, mNextPiece, mNextRotation);	// Draw the next piece
}
